...
test_image_path = 'G:\Shool\Sem 2\Soft Tech 1\Capstone Project\test_image.jpg'
data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)

top = tk.Tk()
top.geometry('800x600')
top.title('Bag Classification')
...
heading = Label(top, text="Bag Material Identification",pady=20, font=('arial',20,'bold'))
